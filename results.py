    ...
    for i in range(len(files)):
        try:
            ...
            try:
                ...
                polygon = [{'let': bounding_box['minlat'], 'lon': bounding_box['minlon']},
                           {'let': bounding_box['minlat'], 'lon': bounding_box['maxlon']},
                           {'let': bounding_box['maxlat'], 'lon': bounding_box['maxlon']},
                           {'let': bounding_box['maxlat'], 'lon': bounding_box['minlon']},
                           {'let': bounding_box['minlat'], 'lon': bounding_box['minlon']}]
                count.append(polygon)
